<script setup>
defineProps(['cell', 'state']);
defineEmits(['reveal', 'flag']);
</script>

<template>
    <button
        class="h-8 w-8 outline outline-1 outline-slate-300 transition-colors duration-150"
        :class="{
    ...
    >
        ...
        <span v-else-if="cell.is_revealed || state === 'over'">
